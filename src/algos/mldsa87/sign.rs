use crate::algos::mldsa87::field::{decompose, fqmul, make_hint, reduce32};
use crate::algos::mldsa87::matrix::PolyMatrix;
use crate::algos::mldsa87::packing::{pack_sig, polyw1_pack, unpack_sk};
...
use crate::algos::mldsa87::params::{
    BETA, GAMMA1, GAMMA2, K, L, LAMBDA2_BYTES, N, OMEGA, POLYW1_BYTES, SIG_BYTES, SK_BYTES,
};
use crate::algos::mldsa87::poly::Poly;
use crate::algos::mldsa87::sampling::{
    expand_a, expand_mask, sample_in_ball, shake256_absorb_squeeze,
};
use crate::algos::mldsa87::vec::{PolyVec, zeroize_polyvec};
...
pub(crate) fn sign(sig: &mut [u8; SIG_BYTES], msg: &[u8], sk: &[u8; SK_BYTES], rnd: &[u8; 32]) {
    ...
    crate::algos::mldsa87::poly::zeroize_poly(&mut c_hat);
}
