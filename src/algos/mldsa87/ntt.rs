...
use crate::algos::mldsa87::field::{fqmul, montgomery_reduce};
use crate::algos::mldsa87::params::N;
...
pub(crate) fn poly_reduce(a: &mut [i32; N]) {
    for c in a.iter_mut() {
        *c = crate::algos::mldsa87::field::reduce32(*c);
    }
}
...
pub(crate) fn poly_caddq(a: &mut [i32; N]) {
    for c in a.iter_mut() {
        *c = crate::algos::mldsa87::field::caddq(*c);
    }
}
