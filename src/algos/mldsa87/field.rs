...
use crate::algos::mldsa87::params::{GAMMA2, Q32, Q64};
...
pub(crate) fn power2round(r: i32) -> (i32, i32) {
    ...
    //   r0 = r - r1*2^d
    let d = crate::algos::mldsa87::params::D;
    let r1 = (r + (1 << (d - 1)) - 1) >> d;
    let r0 = r - (r1 << d);
    (r1, r0)
}
...
pub(crate) fn decompose(r: i32) -> (i32, i32) {
    use crate::algos::mldsa87::params::ALPHA;
...
mod tests {
    ...
    use crate::algos::mldsa87::params::{D, GAMMA2, Q32};
