...
///
/// ```rust
/// use crate::algos::aes256gcm::{Aes256Gcm, AuthError, Nonce};
...
use crate::algos::aes256gcm::aes::cipher::aes256_encrypt_block;
use crate::algos::aes256gcm::aes::{Key256, KeySchedule};
use crate::algos::aes256gcm::gcm::ctr::CtrState;
use crate::algos::aes256gcm::gcm::ghash::GhashState;
